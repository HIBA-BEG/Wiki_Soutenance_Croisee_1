...
<div class="flex justify-center">
    ...
    <div class="relative m-6 ">
        ...
        <input
            class="rounded-lg h-12 flex-1 px-9 py-4 text-pink-500 border-double border-4 border-pink-600 focus:outline-none "
            type="text" id="searchBar" placeholder="search.....">
    </div>
</div>
