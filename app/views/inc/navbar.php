...
<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
	...
	<?php if (isset($_SESSION['id_user'])): ?>
		<a class="hidden lg:inline-block py-2 px-6 bg-pink-500 hover:bg-pink-600 text-sm text-white font-bold rounded-xl transition duration-200"
			href="<?php echo URLROOT; ?>/users/logout">Log Out</a>
	...
	<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			...
			<ul>
				<li class="mb-1">
					<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
						href="<?php echo URLROOT; ?>/users/dashboard">Dashboard</a>
				</li>
				<li class="mb-1">
					<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded"
		...
		<div class="mt-auto">
			...
			<p class="my-4 text-xs text-center text-gray-400">
				<span>Wiki Soutenance Croisée 1 2024</span>
			</p>
		</div>
	</nav>
</div>